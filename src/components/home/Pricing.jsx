    ...
    <div className="xl:container m-auto px-6 py-20 md:px-12 lg:px-20">
      ...
      <div className="mt-12 grid items-center gap-6 md:grid-cols-2 lg:flex lg:space-x-8">
        <div className="group relative md:col-span-1 lg:w-[32%]">
          ...
          <div className="relative space-y-8 p-8">
            ...
            <div className="relative flex justify-around">
              <div className="flex">
                <span className="-ml-6 mt-2 text-2xl sm:text-3xl md:text-4xl font-bold text-primary">
                  $
                </span>
                <span className="leading-0 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-800 dark:text-white">
                  1200
                </span>
              </div>
            </div>
            ...
            >
              <li className="space-x-2">
                <span className="font-semibold text-[#00B1FD]">&#10003;</span>
        ...
        <div className="group relative row-start-1 md:col-span-2 lg:w-[36%]">
          <div
            aria-hidden="true"
            className="absolute top-0 h-full w-full rounded-3xl border border-gray-100 dark:border-[#007FEC] bg-white dark:bg-gray-800 shadow-2xl shadow-gray-600/10 dark:shadow-none transition duration-500 group-hover:scale-105 lg:group-hover:scale-110"
          ></div>
          <div className="relative space-y-8 p-8">
            <h3 className="text-center text-3xl md:text-4xl font-semibold text-gray-700 dark:text-white">
              Development
            </h3>
        ...
        <div className="group relative md:col-span-1 lg:w-[32%]">
          ...
          ></div>
          <div className="relative space-y-8 p-8">
            <h3 className="text-center text-2xl font-semibold text-gray-700 dark:text-white">
              Maintenance
            </h3>
            <div className="relative flex justify-around">
              <div className="flex">
                <span className="-ml-2 mt-2 text-2xl sm:text-3xl md:text-4xl font-bold text-primary">
                  $
                </span>
                <span className="leading-0 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-800 dark:text-white">
                  3000
