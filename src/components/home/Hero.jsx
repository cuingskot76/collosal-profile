...
const Hero = () => {
  return (
    <div className="relative mt-10 sm:mt-20 lg:mt-28 max-w-2xl py-2 px-[1rem] m-auto text-center flex flex-col justify-center items-center">
      ...
      {/* gradient start */}
      <div className="absolute z-[-1] -left-full w-[100%] h-[100%] top-0 orange-gradient" />
      <div className="absolute z-[-2] w-[40%] h-[70%] green-gradient bottom-40" />
      <div className="absolute z-[-1] -right-[50%] w-[100%] h-[100%] bottom-20 red-gradient" />
      {/* gradient end */}
    </div>
  );
};
