...
const Hero = () => {
  return (
    <div className="relative mt-10 sm:mt-20 lg:mt-28 max-w-2xl py-2 px-[1rem] m-auto text-center flex flex-col justify-center items-center">
      ...
      {/* gradient start */}
      <div className="absolute z-[-1] w-[95%] h-[95%] sm:top-0 -left-full orange-gradient" />
      <div className="absolute z-[-2] w-[40%] h-[70%] sm:bottom-40 green-gradient" />
      <div className="absolute z-[-1] w-[100%] h-[100%] sm:-right-[0] 2xl:-right-[50%] bottom-20 red-gradient" />
      {/* gradient end */}
    </div>
  );
};
